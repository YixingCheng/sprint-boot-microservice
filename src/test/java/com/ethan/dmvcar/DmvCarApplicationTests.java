...
import com.ethan.dmvcar.api.rest.CarController;
...
@SpringBootTest(classes = DmvCarApplication.class)
@ActiveProfiles("test")
public class DmvCarApplicationTests {

	public static final String RESOURCE_LOCATION_PATTERN = "http://localhost/example/v1/cars/[0-9]+";
	...
	public void shouldHaveEmptyDB() throws Exception {
		mvc.perform(get("/example/v1/cars")
 ...
 */
	...
	public void shouldCreateAndUpdateAndDelete() throws Exception {
		Car r1 = mockCar("shouldCreateAndUpdate");
		byte[] r1Json = toJson(r1);
		//CREATE
		MvcResult result = mvc.perform(post("/example/v1/cars")
				.content(r1Json)
